...
function OperationRow({ row, type, isLocked, isAdmin }: { row: any; type: OperationType; isLocked: boolean; isAdmin: boolean }) {
  ...
  const closing = asNumber(values.opening) + asNumber(row.inQtyGrams) + asNumber(values.returned) - asNumber(values.issued);
